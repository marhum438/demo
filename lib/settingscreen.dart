            ...
            child: Column(
              children: [
                        ...
                        Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Center(child: Text("Complete Your Profile",style: TextStyle(color: Colors.black,fontSize: 12))),
                ...
                SizedBox(height: 12,),
                 Container(
                  ...
                  child:feild(Icons.share,"Invite & Reference",Colors.black )
                ...
                Container(
                  ...
                  child:feild(Icons.star_border_outlined,"Rate our App", Colors.black)
                ),
                  SizedBox(height: 12,),
                Container(
                  height: 20,
                 ...
                 InkWell(
                   ...
                   child: Container(
                    ...
                    child:feild(Icons.person_2_outlined,"Profile Update", Colors.black)
              ...
              SizedBox(height: 35,),
                ...
                //   padding: const EdgeInsets.only(bottom: 8)),
                 Text("App Version 2.0",style: TextStyle(color: Color.fromARGB(255, 218, 214, 214)),),
