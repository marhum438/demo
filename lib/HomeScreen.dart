              ...
              child: Column(children: [
                ...
                Row(
                  ...
                  children: [
                   ...
                   feild(Icons.pin_drop_outlined, "Plot",Color(0xff5A5A5A) ),
                    SizedBox(
                      width: 10,
                    ),
                  feild(Icons.corporate_fare_outlined, "Commerical",Color(0xff5A5A5A) )
                  ],
                ),
                // SizedBox(height: 12,),
                Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: feild2(Icons.account_tree_outlined, "Project",  Color(0xff9B9C9E)),
                    ),
